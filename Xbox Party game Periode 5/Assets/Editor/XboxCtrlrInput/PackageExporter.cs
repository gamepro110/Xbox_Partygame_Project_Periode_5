...
namespace XboxCtrlrInput.Editor
{
    ...
    {
        private static readonly string DefaultUnityPackageName = "XboxCtrlrInput"; // ODO: add auto incremental version

        private static readonly string[] PackageIgnoredFiles = {
        ...
        private static string[] ListPackageFiles(string rootDir, params string[] ignoredFiles)
        {
