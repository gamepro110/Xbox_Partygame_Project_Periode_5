...
namespace XboxCtrlrInput
{
    ...
    public static class XCI
    {
		...
		public static bool IsPluggedIn(XboxController controllerNumber)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            {
                if (OnWindowsNative())
                {
                    ...
                    // ODO: Remove condition for XboxController.All when the time comes
        ...
        {
            // ACK: On OS X, Left and right trigger under OSX return 0.5 until touched
        ...
        private class XciXInputInitializer
        {
            // Ctor
        ...
        private class XciHandler : MonoBehaviour
        {
            ...
            private void OnSceneFinishedLoading(Scene currentScene, LoadSceneMode mode)
            {
                this.ResetTriggerTouches();
            }

            private void OnApplicationFocus(bool isWindowInFocusNow)
            {
